...
function Pretty() {
  return (
    <div className="relative flex flex-col gap-4 p-3 bg-white/10 rounded-xl w-full xl:w-[70%] xl:h-[20rem] overflow-hidden">
      ...
      <div className="absolute h-[10rem] xl:h-[15rem] w-[10rem] xl:w-[15rem] bg-gradient-to-tl from-red-600 via-rose-400 to-cyan-300 rounded-full top-[20rem] -left-5 animate-float2" />
